...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// buttonGauss
			// 
			this->buttonGauss->Location = System::Drawing::Point(15, 202);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(15, 231);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(15, 260);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(15, 144);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(15, 173);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(75, 23);
			this->button5->TabIndex = 29;
			this->button5->Text = L"Save to file";
